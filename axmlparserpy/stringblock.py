...
class StringBlock:
    ...
    def __init__(self, buff):
        ...
        for i in range(0, size // 4):  # Integer division in Python 3
    ...
    def getRaw(self, idx):
        ...
        while length > 0:
            offset += 2
            # Unicode character - chr() replaces unichr() in Python 3
    ...
    def getShort(self, array, offset):
        value = array[offset // 4].get_value()  # Integer division in Python 3
        if ((offset % 4) // 2) == 0:  # Integer division in Python 3
            return value & 0xFFFF
        else:
            return value >> 16